...
| `data-sms-body` | Wenn `data-sms-url` ein `sms:`-Link ist, wird dieser Wert als SMS-Body verwendet. | siehe `data-url` |
| `data-sms-url`  | Der Link des `sms`-Buttons | `?view=sms` |
