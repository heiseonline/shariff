...
"use strict";module.exports=function(e){var t=encodeURIComponent(e.getURL());return{popup:!1,iframe:!0,shareText:{de:"gefällt mir",en:"like"},name:"facebooklike",title:{de:"Gefällt mir bei Facebook ",en:"Like on Facebook"},shareUrl:"http://www.facebook.com/plugins/like.php?href="+t+e.getReferrerTrack()+"&width&layout=standard&action=like&show_faces=true&share=false&height=80"}};
...
(function (global){
"use strict";var $=(typeof window !== "undefined" ? window.jQuery : typeof global !== "undefined" ? global.jQuery : null),_Shariff=function(e,t){var r=this;this.element=e,this.options=$.extend({},this.defaults,t,$(e).data());var n=[require("./services/facebook"),require("./services/facebook-like"),require("./services/googleplus"),require("./services/twitter"),require("./services/whatsapp"),require("./services/mail"),require("./services/info")];this.services=$.map(this.options.services,function(e){var t;return n.forEach(function(n){return n=n(r),n.name===e?(t=n,null):void 0}),t}),this._addButtonList(),null!==this.options.backendUrl&&this.getShares().then($.proxy(this._updateCounts,this))};_Shariff.prototype={defaults:{theme:"color",backendUrl:null,infoUrl:"http://ct.de/-2467514",lang:"de",orientation:"horizontal",referrerTrack:null,services:["twitter","facebook","facebooklike","googleplus","info"],url:function(){var e=global.document.location.href,t=$("link[rel=canonical]").attr("href")||this.getMeta("og:url")||"";return t.length>0&&(t.indexOf("http")<0&&(t=global.document.location.protocol+"//"+global.document.location.host+t),e=t),e}},$socialshareElement:function(){return $(this.element)},getLocalized:function(e,t){return"object"==typeof e[t]?e[t][this.options.lang]:"string"==typeof e[t]?e[t]:void 0},getMeta:function(e){var t=$('meta[name="'+e+'"],[property="'+e+'"]').attr("content");return t||""},getInfoUrl:function(){return this.options.infoUrl},getURL:function(){var e=this.options.url;return"function"==typeof e?$.proxy(e,this)():e},getReferrerTrack:function(){return this.options.referrerTrack||""},getShares:function(){return $.getJSON(this.options.backendUrl+"?url="+encodeURIComponent(this.getURL()))},_updateCounts:function(e){var t=this;$.each(e,function(e,r){r>=1e3&&(r=Math.round(r/1e3)+"k"),$(t.element).find("."+e+" a").append('<span class="share_count">'+r)})},_addButtonList:function(){var e=this,t=this.$socialshareElement(),r="theme-"+this.options.theme,n="orientation-"+this.options.orientation,i=$("<ul>").addClass(r).addClass(n);this.services.forEach(function(t){var r=$('<li class="shariff-button">').addClass(t.name),n='<span class="share_text">'+e.getLocalized(t,"shareText"),o=$("<a>").attr("href",t.shareUrl).append(n);t.popup?o.attr("rel","popup"):t.iframe?o.addClass("embed-iframe"):o.attr("target","_blank"),o.attr("title",e.getLocalized(t,"title")),r.append(o),i.append(r)}),i.on("click",'[rel="popup"]',function(e){e.preventDefault();var t=$(this).attr("href"),r=$(this).attr("title"),n="600",i="460",o="width="+n+",height="+i;global.window.open(t,r,o)}),$(".embed-iframe").on("click",function(e){e.preventDefault();var t=$(this).attr("href");$(this).replaceWith('<iframe src="'+t+'"></iframe>')}),t.append(i)},abbreviateText:function(e,t){var r=decodeURIComponent(e);if(r.length<=t)return e;var n=r.substring(0,t-1).lastIndexOf(" ");return r=encodeURIComponent(r.substring(0,n))+"…"},getShareText:function(){var e=this.getMeta("DC.title"),t=this.getMeta("DC.creator");return e.length>0&&t.length>0?e+=" - "+t:e=$("title").text(),encodeURIComponent(this.abbreviateText(e,120))}},module.exports=_Shariff,$(".shariff").each(function(){this.shariff=new _Shariff(this)});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./services/facebook":7,"./services/facebook-like":6,"./services/googleplus":8,"./services/info":9,"./services/mail":10,"./services/twitter":11,"./services/whatsapp":12}]},{},[13]);
