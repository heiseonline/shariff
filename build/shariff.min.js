...
(function (global){
"use strict";var $=(typeof window !== "undefined" ? window.jQuery : typeof global !== "undefined" ? global.jQuery : null),_Shariff=function(t,e){var i=this;this.element=t,this.options=$.extend({},this.defaults,e,$(t).data());var r=[require("./services/facebook"),require("./services/facebooklike"),require("./services/xing"),require("./services/googleplus"),require("./services/twitter"),require("./services/whatsapp"),require("./services/mail"),require("./services/info")];this.services=$.map(this.options.services,function(t){var e;return r.forEach(function(r){return r=r(i),r.name===t?(e=r,null):void 0}),e}),this._addButtonList(),null!==this.options.backendUrl&&this.getShares().then($.proxy(this._updateCounts,this))};_Shariff.prototype={defaults:{theme:"color",backendUrl:null,infoUrl:"http://ct.de/-2467514",lang:"de",orientation:"horizontal",referrerTrack:null,countDivisor:1e3,countDivisionStart:1e3,countRoundPrecision:0,services:["twitter","facebook","facebooklike","googleplus","info"],url:function(){var t=global.document.location.href,e=$("link[rel=canonical]").attr("href")||this.getMeta("og:url")||"";return e.length>0&&(e.indexOf("http")<0&&(e=global.document.location.protocol+"//"+global.document.location.host+e),t=e),t}},$socialshareElement:function(){return $(this.element)},getLocalized:function(t,e){return"object"==typeof t[e]?t[e][this.options.lang]:"string"==typeof t[e]?t[e]:void 0},getMeta:function(t){var e=$('meta[name="'+t+'"],[property="'+t+'"]').attr("content");return e||""},getInfoUrl:function(){return this.options.infoUrl},getURL:function(){var t=this.options.url;return"function"==typeof t?$.proxy(t,this)():t},getReferrerTrack:function(){return this.options.referrerTrack||""},getShares:function(){return $.getJSON(this.options.backendUrl+"?url="+encodeURIComponent(this.getURL()))},getCountDivisor:function(){return this.options.countDivisor},getCountDivisionStart:function(){return this.options.countDivisionStart},getCountRoundPrecision:function(){return this.options.countRoundPrecision},_updateCounts:function(t){var e=this,i="";$.each(t,function(t,r){r>=e.getCountDivisionStart()&&(r=Math.round(r/e.getCountDivisor()),i="k"),r>=1e3&&(r=Math.floor(r/1e3)+"."+r%1e3),$(e.element).find("."+t+" a").append('<span class="share_count">'+r+i)})},_addButtonList:function(){var t=this,e=this.$socialshareElement(),i="theme-"+this.options.theme,r="orientation-"+this.options.orientation,o=$("<ul>").addClass(i).addClass(r);this.services.forEach(function(e){var i=$('<li class="shariff-button">').addClass(e.name),r='<span class="share_text">'+t.getLocalized(e,"shareText"),n=$("<a>").attr("href",e.shareUrl).append(r);i.attr("data-popupinfotext",t.getLocalized(e,"popupInfoText")),e.width&&n.data("width",e.width),e.popup?n.attr("rel","popup"):e.iframe?n.attr("rel","iframe"):e.tooltip?n.attr("rel","tooltip"):n.attr("target","_blank"),n.attr("title",t.getLocalized(e,"title")),i.append(n),o.append(i)}),o.on("click",'[rel="popup"]',function(t){t.preventDefault();var e=$(this).attr("href"),i=$(this).attr("title"),r="600",o="460",n="width="+r+",height="+o;global.window.open(e,i,n)}),o.on("click",'[rel="iframe"]',function(t){t.preventDefault();var e=$(this).attr("href");$(this).data("width")&&$(this).parent().width($(this).data("width")),$(this).replaceWith('<iframe src="'+e+'"></iframe>')}),o.on("click",'[rel="tooltip"]',function(t){t.preventDefault();var e=$(this).attr("href"),i=$(this).offset().top-150,r=$(this).offset().left;$(this).data("width")&&$(this).parent().width($(this).data("width")),$("body").prepend('<div class="shariff-tooltip" style="top: '+i+"px; left: "+r+'px;">'+$(this).parent().data("popupinfotext")+'<br><br><iframe style="height: 30px;" src="'+e+'"></iframe></div></div>'),$(document).on("click",function(t){void 0===$(t.target).closest(".shariff-tooltip").get(0)&&void 0===$(t.target).closest("div.shariff").get(0)&&($(".shariff-tooltip").remove(),$(this).off(t))})}),e.append(o)},abbreviateText:function(t,e){var i=decodeURIComponent(t);if(i.length<=e)return t;var r=i.substring(0,e-1).lastIndexOf(" ");return i=encodeURIComponent(i.substring(0,r))+"…"},getShareText:function(){var t=this.getMeta("DC.title"),e=this.getMeta("DC.creator");return t.length>0&&e.length>0?t+=" - "+e:t=$("title").text(),encodeURIComponent(this.abbreviateText(t,120))}},module.exports=_Shariff,$(".shariff").each(function(){this.shariff=new _Shariff(this)});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./services/facebook":6,"./services/facebooklike":7,"./services/googleplus":8,"./services/info":9,"./services/mail":10,"./services/twitter":11,"./services/whatsapp":12,"./services/xing":13}]},{},[14]);
