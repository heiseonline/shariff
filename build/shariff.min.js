...
"use strict";module.exports=function(e){var r=encodeURIComponent(e.getURL());return{popup:!0,shareText:"teilen",name:"facebook",shareUrl:"https://www.facebook.com/sharer/sharer.php?u="+r+e.getReferrerTrack()}};
},{}],3:[function(require,module,exports){
"use strict";module.exports=function(e){return{popup:!0,shareText:"+1",name:"googleplus",shareUrl:"https://plus.google.com/share?url="+e.getURL()+e.getReferrerTrack()}};
...
"use strict";module.exports=function(e){return{popup:!1,shareText:"mail",name:"mail",shareUrl:e.getURL()+"?view=mail"}};
},{}],6:[function(require,module,exports){
"use strict";var $=require("jquery");module.exports=function(t){var e=function(t,e){var r=decodeURIComponent(t);if(r.length<=e)return t;var n=r.substring(0,e-1).lastIndexOf(" ");return r=encodeURIComponent(r.substring(0,n))+"…"},r=function(){var r=t.getMeta("DC.title"),n=t.getMeta("DC.creator");return r.length>0&&n.length>0?r+=" - "+n:r=$("title").text(),encodeURIComponent(e(r,120))};return{popup:!0,shareText:"tweet",name:"twitter",shareUrl:"https://twitter.com/intent/tweet?text="+r()+"&url="+t.getURL()+t.getReferrerTrack()}};
},{"jquery":1}],7:[function(require,module,exports){
(function (global){
"use strict";var $=require("jquery"),_Shariff=function(e,t){var r=this;this.element=e,this.options=$.extend({},this.defaults,t,$(e).data()),this.services=$.map([require("./services/facebook"),require("./services/googleplus"),require("./services/twitter"),require("./services/mail"),require("./services/info")],function(e){return e(r)}),this._addButtonList(),null!==this.options.backendUrl&&this.getShares().then($.proxy(this._updateCounts,this))};_Shariff.prototype={defaults:{theme:"color",backendUrl:null,orientation:"horizontal",referrerTrack:null,services:["twitter","facebook","googleplus","info"],url:function(){var e=global.document.location.href,t=$("link[rel=canonical]").attr("href");return t&&t.length>0&&(t.indexOf("http")<0&&(t=global.document.location.protocol+"//"+global.document.location.host+t),e=t),e}},$socialshareElement:function(){return $(this.element)},getMeta:function(e){var t=$('meta[name="'+e+'"]').attr("content");return t||""},getURL:function(){var e=this.options.url;return"function"==typeof e?e():e},getReferrerTrack:function(){return console.log(this.options.referrerTrack),this.options.referrerTrack||""},getShares:function(){return $.getJSON(this.options.backendUrl+"?url="+encodeURIComponent(this.getURL()))},_updateCounts:function(e){var t=this;$.each(e,function(e,r){r>=1e3&&(r=Math.round(r/1e3)+"k"),$(t.element).find("."+e+" a").append('<span class="share_count">'+r)})},_addButtonList:function(){var e=this,t='<ul class="social_share_area clearfix"></ul>',r=this.$socialshareElement();r.prepend(t);var n=r.find(".social_share_area");n.addClass("theme-"+this.options.theme),n.addClass("orientation-"+this.options.orientation);var i=function(t){var r=!1;return e.options.services.forEach(function(e){t.name===e&&(r=!0)}),r};this.services.filter(i).forEach(function(e){var t=$('<li class="button">').addClass(e.name),r='<span class="share_text">'+e.shareText,i=$("<a>").attr("href",e.shareUrl).append(r);e.popup?i.attr("rel","popup").attr("title",e.name+"-share-dialog"):i.attr("title",e.shareText),t.append(i),n.append(t)}),n.on("click",'[rel="popup"]',function(e){e.preventDefault();var t=$(this).attr("href"),r=$(this).attr("title"),n="600",i="460",a="width="+n+",height="+i;global.window.open(t,r,a)})}},module.exports=_Shariff,$.fn.shariff=function(e){return this.each(function(){this.shariff=new _Shariff(this,e)})},$(".shariff").shariff();
