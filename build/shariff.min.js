...
(function (global){
"use strict";var $=require("jquery"),services=[require("./modules/twitter"),require("./modules/facebook"),require("./modules/gplus"),require("./modules/mail"),require("./modules/info")],_Shariff=function(t,e){var a=this;this.element=t,this.options=$.extend({},this.defaults,e,$(t).data()),this.services=$.map(services,function(t){return t(a)}),this._addButtonList(),this.getShares().then($.proxy(this._updateCounts,this))};_Shariff.prototype={defaults:{theme:"color",backendUrl:"/shariff/",orientation:"horizontal",uri:function(){var t=global.document.location.href,e=$("link[rel=canonical]").attr("href");return e&&e.length>0&&(e.indexOf("http")<0&&(e=global.document.location.protocol+"//"+global.document.location.host+e),t=e),t}},$socialshareElement:function(){return $(this.element)},getMeta:function(t){var e=$('meta[name="'+t+'"]').attr("content");return e||""},getURI:function(){var t=this.options.uri;return"function"==typeof t?t():t},getShares:function(){return $.getJSON(this.options.backendUrl+"?url="+encodeURIComponent(this.getURI()))},_updateCounts:function(t){var e=this;$.each(t,function(t,a){$(e.element).find("."+t+" a").append('<span class="share_count">'+a)})},_addButtonList:function(){var t='<ul class="social_share_area clearfix"></ul>',e=this.$socialshareElement();e.prepend(t);var a=e.find(".social_share_area");a.addClass("theme-"+this.options.theme),a.addClass("orientation-"+this.options.orientation),this.services.forEach(function(t){var e=$('<li class="button">').addClass(t.name),n='<span class="share_text">'+t.shareText,i=$("<a>").attr("href",t.shareUrl).append(n);t.popup?i.attr("rel","popup").attr("title",t.name+"-share-dialog"):i.attr("title",t.shareText),e.append(i),a.append(e)}),a.on("click",'[rel="popup"]',function(t){t.preventDefault();var e=$(this).attr("href"),a=$(this).attr("title"),n="600",i="460",r="width="+n+",height="+i;global.window.open(e,a,r)})}},module.exports=_Shariff,$.fn.shariff=function(t){return this.each(function(){this.shariff=new _Shariff(this,t)})},$(".shariff").shariff({debug:"undefined"!=typeof DEBUG});
